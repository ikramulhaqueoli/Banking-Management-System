...
public class ProfileFrame extends JFrame implements ActionListener, MouseListener
{
	...
	private AdministratorFrame aframe;
	private JOptionPane report;
	private String days[], months[], years[], genders[];

	public ProfileFrame(AdministratorFrame aframe)
	{
		super("Your Profile");
		...
		this.aframe = aframe;
		this.employee = aframe.getLoggedInEmployee();
	...
	public void actionPerformed(ActionEvent ae)
	{
		if(ae.getSource() == changeAvatarButton)
		{
			try
			{
				...
				aframe.refresh();
				ProfileFrame pframe = new ProfileFrame(aframe);

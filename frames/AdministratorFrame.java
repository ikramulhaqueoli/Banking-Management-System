...
import entity.*;
import others.*;
import frames.adminOptions.*;

public class AdministratorFrame extends JFrame implements ActionListener, MouseListener, KeyListener
{
	...
	private JPanel panel, adminEmpPanel;
	private JButton logoutButton, accountButton, profileButton, settingsButton, refreshButton;
	private JButton addEmpButton, viewUserButton, updateEmpButton, statementButton, nowClicked;
	...
	{
		super("Administrative Panel | Amader Bank");
		...
		adminPanelLabel = new JLabel("Administrative Panel");
		...
		addEmpButton.setForeground(new Color(221,221,221));
		addEmpButton.setBackground(new Color(0,0,102));
		addEmpButton.setFont(Common.customFont1SmallestBold);
		addEmpButton.setContentAreaFilled(false);
		addEmpButton.setOpaque(true);
		addEmpButton.setBounds(20, 380, 135, 30);
		addEmpButton.setBorderPainted(false);
		addEmpButton.addMouseListener(this);
		panel.add(addEmpButton);

		viewUserButton = new JButton("View Users");
		viewUserButton.setForeground(new Color(221,221,221));
		viewUserButton.setBackground(new Color(0,0,102));
		viewUserButton.setFont(Common.customFont1SmallestBold);
		viewUserButton.setContentAreaFilled(false);
		viewUserButton.setOpaque(true);
		viewUserButton.setBounds(160, 380, 135, 30);
		viewUserButton.setBorderPainted(false);
		viewUserButton.addMouseListener(this);
		panel.add(viewUserButton);

		updateEmpButton = new JButton("Update Employee");
		updateEmpButton.setForeground(new Color(221,221,221));
		updateEmpButton.setBackground(new Color(0,0,102));
		...
		updateEmpButton.setBounds(300, 380, 135, 30);
		updateEmpButton.setBorderPainted(false);
		updateEmpButton.addMouseListener(this);
		panel.add(updateEmpButton);

		statementButton = new JButton("Statements");
		statementButton.setForeground(new Color(221,221,221));
		statementButton.setBackground(new Color(0,0,102));
		statementButton.setFont(Common.customFont1SmallestBold);
		statementButton.setContentAreaFilled(false);
		statementButton.setOpaque(true);
		statementButton.setBounds(440, 380, 135, 30);
		...
		adminEmpPanel = new JPanel();
		adminEmpPanel.setBackground(new Color(178,178,178));
		adminEmpPanel.setLayout(null);
	...
	public void refresh()
	{
		...
		AdministratorFrame aframe = new AdministratorFrame(loggedInEmployee);
	...
	{
		adminEmpPanel.removeAll();
		if(clicked == addEmpButton)
		{
			(new AdminEssentials()).getSignupFormOnPanel(adminEmpPanel, this);
			scrollablePane.getViewport().add(adminEmpPanel);
			scrollablePane.setHorizontalScrollBarPolicy(JScrollPane.HORIZONTAL_SCROLLBAR_NEVER);
        	scrollablePane.setVerticalScrollBarPolicy(JScrollPane.VERTICAL_SCROLLBAR_AS_NEEDED);
		}
		else if(clicked == viewUserButton)
		{
			(new AdminEssentials()).getViewUserOnPanel(adminEmpPanel, this);
			scrollablePane.getViewport().add(adminEmpPanel);
			scrollablePane.setHorizontalScrollBarPolicy(JScrollPane.HORIZONTAL_SCROLLBAR_NEVER);
        	scrollablePane.setVerticalScrollBarPolicy(JScrollPane.VERTICAL_SCROLLBAR_AS_NEEDED);
		}
		else if(clicked == updateEmpButton)
		{
			(new AdminEssentials()).getUpdateEmpOnPanel(adminEmpPanel, this);
			scrollablePane.getViewport().add(adminEmpPanel);
			scrollablePane.setHorizontalScrollBarPolicy(JScrollPane.HORIZONTAL_SCROLLBAR_NEVER);
        	scrollablePane.setVerticalScrollBarPolicy(JScrollPane.VERTICAL_SCROLLBAR_AS_NEEDED);
		}
		else if(clicked == statementButton)
		{
			(new AdminEssentials()).getStatementOnPanel(adminEmpPanel, this);
			scrollablePane.getViewport().add(adminEmpPanel);
			scrollablePane.setHorizontalScrollBarPolicy(JScrollPane.HORIZONTAL_SCROLLBAR_AS_NEEDED);
        	scrollablePane.setVerticalScrollBarPolicy(JScrollPane.VERTICAL_SCROLLBAR_AS_NEEDED);
		}
	...
	public void mouseEntered(MouseEvent me)
	{
		...
		else if(me.getSource() == addEmpButton)
		{
			addEmpButton.setBackground(new Color(178,178,178));
			addEmpButton.setForeground(new Color(8,8,8));
		}
		else if(me.getSource() == viewUserButton)
		{
			viewUserButton.setBackground(new Color(178,178,178));
			viewUserButton.setForeground(new Color(8,8,8));
		}
		else if(me.getSource() == updateEmpButton)
		{
			updateEmpButton.setBackground(new Color(178,178,178));
			updateEmpButton.setForeground(new Color(8,8,8));
		}
		else if(me.getSource() == statementButton)
		{
			statementButton.setBackground(new Color(178,178,178));
			statementButton.setForeground(new Color(8,8,8));
		}
	}
	...
	{
		if(me.getSource() != addEmpButton && me.getSource() != viewUserButton && me.getSource() != updateEmpButton && me.getSource() != statementButton) return;
		if(nowClicked != null)
		{
